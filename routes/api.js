...
router.post('/inspections', async (req, res) => {
  const pool = req.app.locals.pool
  const { class_name, teacher_name, score, comment, inspection_date } = req.body
  ...
  try {
    const r = await pool.query(
      `INSERT INTO class_inspections (class_name,teacher_name,score,comment,inspection_date)
